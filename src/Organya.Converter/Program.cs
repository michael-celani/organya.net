...
namespace Organya.Converter
{
    class Program
    {
        ...
        {
            using Stream orgStream = new FileStream("/Users/mcelani/Downloads/all/Running Hell NoDrums.org", FileMode.Open);
            ...
            var lookup = OrganyaConverter.Extract(org, instruments);
